...

{
  ...
  # Drives and Mounts
  fileSystems = {
    "/run/media/hurricane/superssd" = {
      device = "/dev/disk/by-uuid/33545447-1e6f-4086-9ad0-aebefd88ce1c";
      fsType = "btrfs";
      options = [ "compress=zstd" ];
    };
    "/run/media/hurricane/arch" = {
      device = "/dev/disk/by-uuid/48310d9a-9a82-4b9e-aae5-13fda5ae3931";
      fsType = "btrfs";
      options = [ "compress=zstd" ];
    };
    "/run/media/hurricane/arch/home" = {
      device = "/dev/disk/by-uuid/48310d9a-9a82-4b9e-aae5-13fda5ae3931";
      fsType = "btrfs";
      options = [ "compress=zstd" "subvol=@home" ];
    };
    "/run/media/hurricane/arch/swap" = {
      device = "/dev/disk/by-uuid/48310d9a-9a82-4b9e-aae5-13fda5ae3931";
      fsType = "btrfs";
      options = [ "compress=zstd" "subvol=@swap" ];
    };
    "/run/media/hurricane/arch/boot" = {
      device = "/dev/disk/by-uuid/5BCE-FA91";
      fsType = "vfat";
      options = [ "fmask=0022" "dmask=0022" ];
    };
    "/home/hurricane/.local/share/PrismLauncher" = {
      device =
        "/run/media/hurricane/arch/home/hurricane/.local/share/PrismLauncher";
      fsType = "none";
      options = [ "bind" ];
      depends = [ "/run/media/hurricane/arch/home" "/home" ];
    };
    "/run/media/hurricane/backup" = {
      device = "/dev/disk/by-uuid/15fd26b0-1b43-42b8-945d-5fa5ccdd2b0a";
      fsType = "ext4";
      options = [ "defaults" ];
    };
    "/home/hurricane/.config/Bionus" = {
      device = "/run/media/hurricane/arch/home/hurricane/.config/Bionus";
      fsType = "none";
      options = [ "bind" ];
      depends = [ "/run/media/hurricane/arch/home" "/home" ];
    };
